package com.user_service.security.auth;

import com.user_service.security.MainUser;
import com.user_service.security.dto.JwtTokenDto;
import com.user_service.security.dto.LoginRequestDto;
import com.user_service.security.jwt.JwtToken;
...
//controlador para manejar las peticiones de autenticacion y permisos
    ...
    public ResponseEntity<JwtTokenDto> login(@RequestBody LoginRequestDto loginRequestDto) {
        log.info("> login >> " + loginRequestDto.getEmail());
